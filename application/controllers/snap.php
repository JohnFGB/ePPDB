...
class Snap extends CI_Controller {
    ...
    {
        parent::__construct();
        $params = array('server_key' => 'SB-Mid-server--GamaDNgwWV_c3Yp_uJynXX9', 'production' => false);
    ...
    public function token()
    {
		...
		$item1_details = array(
		  ...
		  'price' => 250000,
		  'quantity' => 1,
		  'name' => "Pembayaran Formulir Pendaftaran Calon Siswa"
		);
		...
		$customer_details = array(
		  'first_name'    => $data['user']->nama_lengkap,
		  'last_name'     => $data['user']->nisn,
