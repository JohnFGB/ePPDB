...
class Panel_admin extends CI_Controller {
	...
	{
		$ceks = $this->session->userdata('un@smkn2_cibinong');
		if(!isset($ceks)) {
								 ...
								 redirect('panel_admin/log_in');
										 ...
										 if($cekpass <> $pass) {
												...
												redirect('panel_admin/log_in');
																...
																$this->session->set_userdata('un@smkn2_cibinong', "$cekun");
			...
			$data['judul_web'] 		= "Profile";
					...
					if (isset($_POST['btnupdate'])) {
						...
						$nama_lengkap	= $this->input->post('nama_lengkap');
									...
									$this->session->has_userdata('un@smkn2_cibinong');
									$this->session->set_userdata('un@smkn2_cibinong', "$username");
	...
	public function logout() {
     if ($this->session->has_userdata('un@smkn2_cibinong') != '' AND $this->session->has_userdata('id_user@sman1_belitang') != '') {
  ...
  public function add()
  {
	  ...
	  $this->load->view("admin/crud/edit");
	  $this->load->view("admin/footer");
  }
  ...
  public function edit($id = null)
  {
	$ceks = $this->session->userdata('un@smkn2_cibinong');
	$data['user']  			  = $this->db->get_where('tbl_user', "username='$ceks'");
	$data['judul_web']  	  = 'Edit Data';
	  if (!isset($id)) redirect('panel_admin/verifikasi');
  ...
  public function delete($id=null)
  {
	  ...
	  if ($this->Model_siswa->delete($id)) {
		$this->session->set_flashdata('hapus', 'Berhasil Dihapus');
		  redirect(site_url('panel_admin/verifikasi/'));
	  }
  }
  ...
  public function detail($id=null)
  {
	...
	$data['judul_web']  	  = 'Cek Data';
	  ...
	  $this->load->view("admin/header", $data);
	  $this->load->view("admin/crud/cek", $data);
	  $this->load->view("admin/footer");
}
}