...
<div class="form-group">
    <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">Jurusan Yang Dipilih <span class="text-danger">*</span></label>
    <div class="col-sm-9" style="margin-top:3px;">
      <select class="form-control bg-blue class" data-placeholder="Pilih Jurusan" name="jurusan" data-parsley-group="block3" data-parsley-errors-container='div[id="error-jurusan"]' required>
              <option value="">Pilih Jurusan</option>
              <option value="musik">Musik Klasik</option>
