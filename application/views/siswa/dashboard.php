      ...
      <div class="panel panel-flat bg-info">
        <div class="panel-heading">
          <h3 class="panel-title">
            <center>Halo <?php echo ucwords($nama); ?>, Selamat Datang Calon Siswa SMKN 2 Cibinong</center>
          </h3>
        </div>
      </div>
      <!-- /basic datatable -->
            ...
            <div class="panel panel-flat bg-success">
              <div class="panel-heading">
                <h4 class="panel-title">
                  <center>
                    <i class="glyphicon glyphicon-bullhorn"></i> Selamat <b><?php echo $nama; ?></b> <span class="label label-info" style="font-size:20px;">Lulus</span> Seleksi Sebagai Calon Peserta Didik Baru <b>SMKN 2 Cibinong</b>, Silahkan Cetak Surat Pengumuman Sebagai Bukti Lulus Seleksi.
              ...
              <div class="panel-heading">
                <h4 class="panel-title">
                  <center>
                    ...
                    Sebagai Calon Peserta Didik Baru <b>SMKN 2 Cibinong</b>.
                  </center>
                </h4>
              </div>
            </div>
