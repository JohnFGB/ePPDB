...
<html>
  ...
  <body onload="window.print();">
    ...
    <h4 align="center" style="margin:0px;font-size:19px;"><u><b>S U R A T  P E N G U M U M A N</b></u></h4>
      <center>
        No : 420/<?php echo $user->no_pendaftaran; ?>/PPDB.SMKN2CBN/<?php echo $thn_ppdb; ?>
      </center>

    <br>
    <table width="100%" border="0">
      <tr>
        <td colspan="3">Kepala SMKN 2 Cibinong dengan ini menyatakan bahwa :</td>
      </tr>
      <tr>
    ...
    Seleksi Sebagai Calon Peserta Didik SMKN 2 Cibinong tahun ajaran <?php echo $thn_ppdb; ?>/<?php echo $thn_ppdb+1; ?>.<br>
    Demikian pengumuman ini disampaikan untuk dapat digunakan sebagai mestinya.
    <br><br>

    <div style="float:right;">
      Cibinong, <?php echo $this->Model_data->tgl_id(date('d-m-Y')); ?> <br>
			Kepala Sekolah,  <br>
      <img src="<?= base_url('img/ttd2.png'); ?>" alt="" width="100"><br>
      <br>
      <b><u>Abdhan S Mahendra, S.Pd., MM.</u></b><br>
      NIP. 6969
    </div>
    <br><br><br><br><br><br>
